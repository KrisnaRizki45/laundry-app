      ...
      children: [
        {
          ...
          children: [
            ...
            { path: 'employe/products/edit', element: <EditProduct /> },
            { path: 'employe/customer', element: <CustomerList /> },
            { path: 'employe/customer/add', element: <AddCustomer /> },
            { path: 'employe/customer/edit', element: <EditCustomer /> },
            { path: 'employe/transaction', element: <TransactionList /> },
            { path: 'employe/transaction/details', element: <TransactionDetails /> },
